...
function AddProduct() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const response = await axios.get(`${config.API_URL}/admin/getAllCategories`, authconfig);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${config.API_URL}/admin/addProduct`, formData, authconfig);
